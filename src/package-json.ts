...
async function createPackageJson(answers: Answers): Promise<boolean> {
  ...
  const pkg = {
    ...
    bugs: { url: answers.gitUser ? `https://github.com/${answers.gitUser.username}/${answers.repoName}/issues` : "" },
    homepage: answers.gitUser ? `https://github.com/${answers.gitUser.username}/${answers.repoName}` : "",
